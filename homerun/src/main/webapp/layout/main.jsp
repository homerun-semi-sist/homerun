			...
			<div class="right">
				...
				<div class="login-box">
					...
					<button type="button" class="login"
						onclick="location.href='<%=root%>/user/user_loginform.jsp'">로그인</button>
					<br> <a class="regist"
						href="<%=root%>/regist/regist_registform.jsp">회원가입</a>
				</div>
				<%
				} else {
				%>
				<div class="logout-box">
					<b class="text2">환영합니다 </b><br> <img class="photo"
						src="<%=root%>/assets/img/로그인프로필.png"> <b class="uid"><%=uid%></b>
					<button type="button" class="logout"
						onclick="location.href='<%=root%>/user/user_logoutaction.jsp'">로그아웃</button>
				</div>
				<%
				}
				%>
