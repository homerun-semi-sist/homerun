      ...
      <div class=" gx-5 align-items-center">
        ...
        <div class="col-lg-6">
          <div class="d-flex align-items-center justify-content-center">
            <!-- <a href="index.jsp" class="navbar-brand">
            	<img src="assets/img/로고.png" style="width: 150px;"/>
            </a> -->
            <img src="assets/img/로고.png" style="width: 150px;"/>
          </div>
        </div>
        <div class="col-lg-3" style="margin-top: 20px;">
          <div class="d-flex align-items-center justify-content-end">
            <span class="me-3"
              ><span class="uname_title">박예은</span
              ><span class="a_title">님</span></span
            >
            <a class="a_title" href="#"><span>마이페이지</span></a
            ><span class="a_title">&nbsp;|&nbsp;</span>
            <a style="color: white;" href="#"><span>장바구니</span></a>
          </div>
        </div>
      </div>
    </div>
