								...
								<div class="carousel slide" id="carouselCategoryDoosanTeamwear"
									...
									<div class="carousel-inner">
										...
										<div class="carousel-item">
											<div class="row h-100 align-items-center g-2">
												<%
												int last_dt = subListbase_dt.size() > 8 ? 8 : subListbase_dt.size();
								...
								<div class="carousel slide" id="carouselCategoryLotteTeamwear"
									...
									<div class="carousel-inner">
										...
										<div class="carousel-item active" data-bs-interval="10000">
											<div class="row h-100 align-items-center g-2">
											<%
												List<ProductDto> subListbase_lt = new ArrayList<>();
												for (int i = 0; i < list.size(); i++) {
													ProductDto dto = list.get(i);
													if (dto.getTeamName().equals("롯데 자이언츠")) {
														if (dto.getpCategory().equals("팀웨어")) {

															subListbase_lt.add(dto);
														}
													}
												}
												%>
												...
												int last_lt_1 = subListbase_lt.size() < 4 ? subListbase_lt.size() : 4;
												List<ProductDto> subList_1_lt = new ArrayList<ProductDto>(subListbase_lt.subList(0, last_lt_1));
												for (int j = 0; j < subList_1_lt.size(); j++) {
													ProductDto dto = subList_1_lt.get(j);
												%>
												<div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
													<div class="card card-span h-100 text-white">
														<img class="img-fluid h-100"
														...
														<div class="card-body ps-0 bg-200">
															...
															<div class="fw-bold">
																<span class="text-600 me-2 text-decoration-line-through">$200</span><span
																	class="text-primary"><%=dto.getPrice() %></span>
															</div>
														</div>
														<a class="stretched-link" href="#"></a>
													</div>
