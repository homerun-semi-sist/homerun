	...
	<div class="fbList"
		...
		<div class="title">
			...
			<div class="go" style="float: right;">
				<a href="<%=root%>/freeBoard/freeBoard_listPage.jsp"
		...
		<ul style="font-size: 1.2em;">
			...
			<li style="margin-bottom: 8px;"><a
				href="<%=root%>/freeBoard/freePost_detailPage.jsp?fbNum=<%=dto.getFbNum()%>&currentPage=1"
				style="text-decoration: none; color: black;"><%=dto.getFbSubject()%></a></li>
			<%
			}
			%>
		</ul>
