   ...
   $(function() {
      ...
      $("#allcheck").click(function() {
         ...
         var price=0;
          ...
          $(".cId:checked").each(function(i,ele){
               price+=parseInt($(this).attr("price"))*parseInt($(this).attr("cQTY"));
...
<body style="overflow-x: hidden;">
               ...
               <body>
                  ...
                  <div style="text-align: center; margin-left: 100px;">
                     ...
                     <table class="table table-bordered"
                        ...
                        <tr>
                           <td style="line-height: 100px;"><input type="checkbox" name="cId" class="cId moneycheck"
                              cId="<%=map.get("cId")%>" price="<%=map.get("price") %>" cQTY="<%=map.get("cQTY") %>"  ></td>
                              ...
                              <div pId="<%=map.get("pId")%>" class="pName">
                                 ...
                                 <td >
                                       <span style="line-height:35px"
                                          class="glyphicon glyphicon-triangle-top cQTYup" cId="<%=map.get("cId")%>" cQTY="<%=map.get("cQTY")%>" pStock="<%=map.get("pStock")%>"></span><br>
                                       <span><b> 수량: <%=map.get("cQTY")%>개</b></span> 
                                          <br><span
                                          class="glyphicon glyphicon-triangle-bottom cQTYdown" cId="<%=map.get("cId")%>" cQTY="<%=map.get("cQTY")%>" pStock="<%=map.get("pStock")%>"></span>
                                    </td>
                                 <td><br>
  ...
  <tr>
                           <td colspan="5"   style="font-size:2em"><b>총 주문금액: &\#8361;
                           <span class="endprice"
                              style=""><br></span></b><br>
                              <span style="margin-left:90px"><button type="button" class="btn1" style=""
                                 id="btncartdel">상품삭제</button>
