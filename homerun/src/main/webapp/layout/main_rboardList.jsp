...
<body>
	...
	<div class="fbList"
		style="width: 100%; height: 100%; border: 0px solid gray;">
		<div class="title">
			<div style="float: left;">
				<b style="font-size: 1.4em;">후기게시판 최근게시글</b>
			</div>
			<div class="go" style="float: right;">
				<a href="<%=root%>/reviewBoard/reviewBoard_listPage.jsp"
					style="text-decoration: none; color: black;">더보기&nbsp;<i
		...
		<ul style="font-size: 1.2em;">
			...
			<li style="margin-bottom: 8px;"><a
				href="<%=root%>/reviewBoard/reviewPost_detailPage.jsp?rbNum=<%=dto.getRbNum()%>&currentPage=1"
				style="text-decoration: none; color: black;"><%=dto.getRbSubject()%></a></li>
			<%
			}
			%>
		</ul>
