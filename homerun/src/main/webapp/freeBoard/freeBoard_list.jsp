...
#naavs-top-all, #naavs-top-doosan, #naavs-top-kiwoom, #naavs-top-samsung,
	#naavs-top-lg, #naavs-top-kt, #naavs-top-ssg, #naavs-top-nc,
	#naavs-top-lotte, #naavs-top-kia, #naavs-top-hanhwa {
	opacity: 1;
}
</style>
				...
				<div class="flex-grow-1 container-p-y">
					...
					<div class="card" style="background-color: #fff">
						<h3 class="card-header">
							<a href='freeBoard_listPage.jsp'
								style="text-decoration: none; color: black;"><b>자&nbsp;유&nbsp;게&nbsp;시&nbsp;판&nbsp;<sapn
										class="fbTitle" style="font-size: 0.8em;">_&nbsp;전체</span></b></a>
						</h3>
							...
							<ul class="naav naav-tabs naav-fill" role="tablist"
								...
								<li class="naav-item">
									<button type="button" class="naav-link active" role="tab"
										data-bs-toggle="tab" data-bs-target="#naavs-top-all"
										aria-controls="naavs-top-all" aria-selected="true"
										category="All">전체</button>
								</li>
								<li class="naav-item">
									<button type="button" class="naav-link" role="tab"
										data-bs-toggle="tab" data-bs-target="#naavs-top-kia"
										aria-controls="naavs-top-kia" aria-selected="false"
										category="KIA">KIA</button>
								</li>
								<li class="naav-item">
									<button type="button" class="naav-link" role="tab"
										data-bs-toggle="tab" data-bs-target="#naavs-top-kt"
										aria-controls="naavs-top-kt" aria-selected="false"
										category="KT">KT</button>
								</li>
								<li class="naav-item">
									<button type="button" class="naav-link" role="tab"
										data-bs-toggle="tab" data-bs-target="#naavs-top-lg"
										aria-controls="naavs-top-lg" aria-selected="false"
										category="LG">LG</button>
								</li>
								<li class="naav-item">
									<button type="button" class="naav-link" role="tab"
										data-bs-toggle="tab" data-bs-target="#naavs-top-nc"
										aria-controls="naavs-top-nc" aria-selected="false"
										category="NC">NC</button>
								</li>
								<li class="naav-item">
									<button type="button" class="naav-link" role="tab"
										data-bs-toggle="tab" data-bs-target="#naavs-top-ssg"
										aria-controls="naavs-top-ssg" aria-selected="false"
										category="SSG">SSG</button>
								</li>
								<li class="naav-item">
									<button type="button" class="naav-link" role="tab"
										data-bs-toggle="tab" data-bs-target="#naavs-top-doosan"
										aria-controls="naavs-top-doosan" aria-selected="false"
										category="두산">두산</button>
								</li>
								<li class="naav-item">
									<button type="button" class="naav-link" role="tab"
										data-bs-toggle="tab" data-bs-target="#naavs-top-lotte"
										aria-controls="naavs-top-lotte" aria-selected="false"
										category="롯데">롯데</button>
								</li>
								<li class="naav-item">
									<button type="button" class="naav-link" role="tab"
										data-bs-toggle="tab" data-bs-target="#naavs-top-samsung"
										aria-controls="naavs-top-samsung" aria-selected="false"
										category="삼성">삼성</button>
								</li>
								<li class="naav-item">
									<button type="button" class="naav-link" role="tab"
										data-bs-toggle="tab" data-bs-target="#naavs-top-kiwoom"
										aria-controls="naavs-top-kiwoom" aria-selected="false"
										category="키움">키움</button>
								</li>
								<li class="naav-item">
									<button type="button" class="naav-link" role="tab"
										data-bs-toggle="tab" data-bs-target="#naavs-top-hanhwa"
										aria-controls="naavs-top-hanhwa" aria-selected="false"
										category="한화">한화</button>
								</li>
							</ul>

							<!-- tab별 내용 -->
							<div class="tab-content">
								<div class="tab-pane fade show active" id="naavs-top-all"
									role="tabpanel">
									<div class="fList"></div>
									...
									<div style="width: 500px; text-align: center;"
										...
										<ul class="pagination">
											...
											%>
											<li><a
												href="freeBoard_listPage.jsp?currentPage=<%=startPage - 1%>">이전</a>
											</li>
											<%
											}
											...
											%>
											<li class="active"><a
												href="freeBoard_listPage.jsp?currentPage=<%=pp%>"><%=pp%></a>
											</li>
											<%
											} else {
											%>
											...
											%>
											<li><a
												href="freeBoard_listPage.jsp?currentPage=<%=endPage + 1%>">다음</a>
											</li>
											<%
											}
											%>
								...
								<div class="tab-pane fade" id="naavs-top-samsung"
									role="tabpanel">
									<div class="ffList"></div>
