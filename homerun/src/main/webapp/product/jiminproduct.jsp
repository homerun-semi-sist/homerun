											...
											<div class="row h-100 align-items-center g-2">
												...
												<div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
													<div class="card card-span h-100 text-white">
														<img class="img-fluid h-100" src="<%=pDto.getpImage()%>"
															alt="..." />
														<div class="card-img-overlay ps-0"></div>
														<div class="card-body ps-0 bg-200">
															<h5 class="fw-bold text-1000 text-truncate"><%=pDto.getpName()%></h5>
															<div class="fw-bold">
																<span class="text-primary"><%=nf.format(pDto.getPrice())%></span>
															</div>
														</div>
														<a class="stretched-link"
															href="product_detailPage.jsp?pId=<%=pDto.getpId()%>"></a>
													</div>
												</div>
												<%
													//}
										...
										<div class="carousel-item">
											...
											%>
												<div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
													<div class="card card-span h-100 text-white">
														<img class="img-fluid h-100"
															src="<%=pDto.getpImage()%>" alt="..." />
														<div class="card-img-overlay ps-0"></div>
														<div class="card-body ps-0 bg-200">
															<h5 class="fw-bold text-1000 text-truncate"><%=pDto.getpName()%></h5>
															<div class="fw-bold">
																<span class="text-600 me-2 text-decoration-line-through">$200</span><span
																	class="text-primary"><%=nf.format(pDto.getPrice())%></span>
															</div>
														</div>
														<a class="stretched-link" href="#"></a>
													</div>
									...
									<div class="carousel-inner">
										...
										<div class="carousel-item active" data-bs-interval="10000">
											<div class="row h-100 align-items-center g-2">
												...
												//int n = 4;
												//System.out.println(list.size());
												ArrayList<ProductDto> pList_c = new ArrayList<ProductDto>();
												int n_c = 0;
										...
										<div class="carousel-item">
											<div class="row h-100 align-items-center g-2">
											<%
											int a_c = (pList_c.size() > 8 ? 8 : pList_c.size());
											System.out.println(pList_c.size());
											for(int i=4;i<a_c;i++){
												ProductDto pDto=pList_c.get(i);
												//if(i < 4) {
												// System.out.println(i);
