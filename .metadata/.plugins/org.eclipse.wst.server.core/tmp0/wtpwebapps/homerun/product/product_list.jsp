    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <div class="fs-5 mb-5">
                    <span class="text-decoration-line-through">109,900원</span>
                    <span>89,900원</span>
                </div>
                <p class="lead">
                    어센틱 유니폼은 선수에게 지급되는 상품과 동일한 원단, 부자재
                    등으로 제작한 상품입니다. 마킹카트 부착 서비스 구매 시 유니폼
                    제작은 2주가량 소요됩니다.
                </p>
                <div class="d-flex">
                    <input
        ...
        <div class="px-4">
            <div class="d-flex justify-content-between small">
                <div class="text-muted">
                    Copyright &copy; HOMERUN sist1226 semi_2
                </div>
                <div class="text-muted">
                    <a style="color: white" class="text-muted" href="#">Register</a>
                    &middot;
                    <a
                            style="color: white"
                            class="text-muted"
                            href="https://github.com/semi-project-SIST/semi-project-SIST"
                    >semi-project-SIST</a
                    >
                </div>
            </div>
