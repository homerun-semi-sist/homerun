									...
									.ajax({
										...
										success : function(res) {
											...
											if (category == "fb")
												...
												if (res.length == 0) {
													s += "<tr>";
													s += "<td colspan='10' align='center' style='font-size: 18pt;'>아직 작성한 게시글이 없습니다</td>";
													s += "</tr>";
												} else {
													$
															.each(
				...
				.on(
						...
						function() {
							...
							if (a) {
								...
								if (category == "fb")
									location.href = "../freeBoard/freePost_updatePage.jsp?fbNum="
											+ num;
								else
									location.href = "../reviewBoard/reviewPost_updatePage.jsp?rbNum="
											+ num;
							}
						});
	})
				...
				<div class="flex-grow-1 container-p-y">
					...
					<div class="card" style="background-color: #fff">
						<h3 class="card-header">
							<a href='mypage_bookmarkListPage.jsp'
								style="text-decoration: none; color: black;"><b>내&nbsp;글&nbsp;목&nbsp;록<sapn
