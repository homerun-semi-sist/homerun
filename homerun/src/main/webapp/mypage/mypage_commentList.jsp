												...
												$
														.each(
																...
																function(idx,
																	...
																	s += "<a class='dropdown-item delUserBtn' href='#?fbNum="
																			+ item.fbNum
				...
				<div class="flex-grow-1 container-p-y">
					...
					<div class="card" style="background-color: #fff">
						<h3 class="card-header">
							<a href='mypage_commentListPage.jsp'
								style="text-decoration: none; color: black;"><b>내&nbsp;댓&nbsp;글&nbsp;목&nbsp;록<sapn
										class="bTitle" style="font-size: 0.8em;">_&nbsp;자유게시판
									댓글</span></b></a>
						</h3>
						...
						<div class="naav-align-top mb-4">
							<ul class="naav naav-tabs naav-fill" role="tablist"
								...
								<li class="naav-item">
									<button type="button" class="naav-link active" role="tab"
										...
										aria-controls="naavs-top-fc" aria-selected="true"
							...
							<div class="tab-content">
								<div class="tab-pane fade show active" id="naavs-top-fc"
									role="tabpanel">
									...
									<div style="width: 500px; text-align: center;"
										...
										<ul class="pagination">
											...
											%>
											<li><a
												href="mypage_commentListPage.jsp?currentPage=<%=startPage - 1%>">이전</a>
											</li>
											<%
											}
											...
											%>
											<li class="active"><a
												href="mypage_commentListPage.jsp?currentPage=<%=pp%>"> <%=pp%>
											</a></li>
											<%
											} else {
											%>
											...
											%>
											<li><a
												href="mypage_commentListPage.jsp?currentPage=<%=endPage + 1%>">다음</a>
											</li>
											<%
											}
											%>
