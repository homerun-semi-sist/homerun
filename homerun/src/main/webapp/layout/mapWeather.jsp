...
<body>
	<div class="box" style="width: 100%; height: 100%;">
		...
		String URL = "https://search.naver.com/search.naver?sm=tab_hty.top&where=nexearch&query=" + place + "+날씨&oquery="
				+ place + "+날씨&tqi=isynnlprvxZsstNKUjhsssssszs-082509";
		Document doc;

		doc = Jsoup.connect(URL).get();
		Elements temperature_text = doc.select("div.main_pack div.weather_info div._today div.temperature_text strong");
		Elements temperature_info_text = doc
				.select("div.main_pack div.weather_info div._today div.temperature_info span.weather");
		Elements finedust_text = doc
				.select("div.main_pack div.weather_info div.report_card_wrap ul.today_chart_list li.item_today span.txt");
		Elements feel_humidity = doc
				.select("div.main_pack div.weather_info div._today div.temperature_info dl.summary_list dd.desc");
		...
		<div class="wBox">
			...
			<div class="weather wImg">
				<img
					src="<%=root%>/assets/img/weather/<%=temperature_info%>(<%=str%>).png"
					onerror="this.src='<%=root%>/assets/img/weather/<%=temperature_info%>.png';">
			</div>
			<div class="weather tem_text"><%=temperature%></div>
			<div class="weather tem_info"><%=temperature_info%></div>
			<div class="weather dust">
				미세먼지<br>
				<span style="font-weight: bold; color: #F69E7B;"><%=finedust%></span>
			</div>
			<div class="weather humidity">
				습도<br>
				<span style="font-weight: bold; color: #748DA6;"><%=humidity%></span>
			</div>
			<div class="weather feel">
				체감 온도<br>
				<span style="font-weight: bold; color: #FF8787;"><%=feel%></span>
			</div>
		</div>
					...
					var infowindow = new kakao.maps.InfoWindow(
							{
								...
								content : "<div class='wrap'>"
										+ "<div class='teamBox'>"
										+ "<div class='team' style='background-color:" + positions[i].color + ";'>"
										+ positions[i].team
										+ "</div>"
										+ "<div class='body'>"
										+ "<div class='img'>"
										...
										+ positions[i].stadium + "<br>"
										+ positions[i].location + "</div>"
										+ "</div>" + "</div>" + "</div>"
							});
