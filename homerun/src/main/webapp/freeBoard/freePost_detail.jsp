...
<title>HOMERUN | FREEPOST_DETAIL</title>
							...
							<div class="row">
								...
								<div class="col">
									...
									<article class="blog-details" style="background-color: #fff;">
										...
										%>
										<span class="title" style="color: #0b214e;"> <img
											src="https://cdn.icon-icons.com/icons2/2070/PNG/512/baseball_icon_126956.png"
											style="width: 40px;"> <%=fbDto.getFbSubject()%></span>
										...
										<span class="title" style="color: #0b214e;"> <img
											...
											width="60px;"> <%=fbDto.getFbSubject()%></span>
										<%
										} else {
										%>
										<span class="title" style="color: #0b214e;"> <img
											src="<%=tDao.getTeam(fbDto.getFbCategory()).getTeamLogo()%>"
											width="50px;"> <%=fbDto.getFbSubject()%></span>
										...
										<span style="float: right; margin-top: 20px; cursor: pointer;"
											onclick="funDel(<%=fbNum%>, <%=currentPage%>)">삭제</span> <span
											style="float: right; margin-top: 20px;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
										<span style="float: right; margin-top: 20px; cursor: pointer;"
											onclick="location.href='freePost_updatePage.jsp?fbNum=<%=fbDto.getFbNum()%>&currentPage=<%=currentPage%>'">수정</span>
										<%
										} else {
										...
										<div class="meta-top">
											...
											<span style="float: right;"><i
												class="fa-regular fa-thumbs-down"></i><span id="dlcnt"><%=fbDto.getFbDislike()%></span></span>
											<span style="float: right;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
											<span style="float: right;"><i
												class="fa-regular fa-thumbs-up"></i><span id="lcnt"><%=fbDto.getFbLike()%></span></span>
											<span style="float: right;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
											<span style="float: right;"><i
												class="fa-regular fa-eye"></i><%=fbDto.getFbReadCnt()%></span> <span
												style="float: right;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
											<%
											}
											%>
											<span style="float: right;"><i
												class="fa-regular fa-calendar"></i><%=sdf.format(fbDto.getFbWriteday())%></span>
										</div>
										<!-- End meta top -->
										<hr>
										...
										<div class="comments">
											<div class="reply-form" style="background-color: #F8F9FA;">
												...
												<div class="row" style="margin-top: 20px;">
													...
													<div class="col-1">
														<button type="button" id="cInsertBtn"
										...
										<div class="comments">
											<div class="reply-form" style="background-color: #F8F9FA;">
												...
												<div class="row" style="margin-top: 20px;">
													...
													<div class="col-1">
														<button type="button" id="cUpdateBtn" fcIdx=""
															class="btn btn-primary"
