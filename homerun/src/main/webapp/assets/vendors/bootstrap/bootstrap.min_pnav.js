...
!(function (t, e) {
  ...
  class ut extends z {
    ...
    _detectNavbar() {
      return null !== this._element.closest(".navvbar");
    }
    _getOffset() {
  ...
  class Vt extends z {
    constructor(t, e) {
      super(t),
        ...
        (this._config = this._getConfig(e)),
        (this._selector = `${this._config.target} .navv-link, ${this._config.target} .list-group-item, ${this._config.target} .dropdown-item`),
        (this._offsets = []),
        (this._targets = []),
    ...
    _activate(t) {
      ...
      s.classList.contains("dropdown-item")
        ...
        : (s.classList.add("active"),
          i.parents(s, ".navv, .list-group").forEach((t) => {
            i
              .prev(t, ".navv-link, .list-group-item")
              .forEach((t) => t.classList.add("active")),
              i.prev(t, ".navv-item").forEach((t) => {
                i.children(t, ".navv-link").forEach((t) =>
  ...
  class Qt extends z {
    ...
    show() {
      ...
      const e = a(this._element),
        s = this._element.closest(".navv, .list-group");
      if (s) {
        const e =
